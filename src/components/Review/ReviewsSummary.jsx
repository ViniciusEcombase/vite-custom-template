...
const ReviewsSummary = ({
  ...
  return (
    <>
      {payload.data[0].ai_summary.summary_text !== null && (
          ...
          <div className="reviews-summary">
            ...
            <div className="reviews-summary__stats">
              <div className="reviews-summary__stat">
                ...
                <StarRating
                  rating={Math.round(payload.data[0].average_rating)}
                />
        ...
        <div className="reviews-container reviews-container--summary">
          <div className="reviews-summary">
            ...
            <div
              ...
              className="reviews-summary__header"
            >
              <h2
                style={{ display: 'flex', justifyContent: 'center' }}
                className="reviews-summary__title"
              >
                No summary yet
              </h2>
            </div>
            ...
            <div
              style={{ display: 'flex', justifyContent: 'center' }}
              className="reviews-summary__actions"
            >
              <Button
                variant={'outline'}
              ...
              <Button
                variant={'primary'}
                text="Write Review"
                startIcon={<Plus className="btn__icon" />}
